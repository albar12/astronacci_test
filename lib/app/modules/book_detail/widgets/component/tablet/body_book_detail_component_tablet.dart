...
class BodyBookDetailComponentTablet extends StatefulWidget {
  const BodyBookDetailComponentTablet({
    super.key,
    required this.size,
    required this.state,
    this.isFree,
  ...
  @override
  State<BodyBookDetailComponentTablet> createState() =>
      _BodyBookDetailComponentTabletState();
}

class _BodyBookDetailComponentTabletState
    extends State<BodyBookDetailComponentTablet> {
  @override
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(
                  '-',
                  style: FontFamilyConstant.primaryFont.copyWith(fontSize: 18),
                ),
              ],
            ),
            const SizedBox(height: 8),
