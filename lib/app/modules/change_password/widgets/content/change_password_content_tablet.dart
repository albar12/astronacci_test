...
class ChangePasswordContentTablet extends StatefulWidget {
  const ChangePasswordContentTablet({
    super.key,
    required this.size,
  });
  final Size size;
  ...
  @override
  State<ChangePasswordContentTablet> createState() => _ChangePasswordContentTabletState();
}

class _ChangePasswordContentTabletState extends State<ChangePasswordContentTablet> {
