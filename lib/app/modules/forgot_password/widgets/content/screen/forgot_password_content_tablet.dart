...
class ForgotPasswordContentTablet extends StatefulWidget {
  const ForgotPasswordContentTablet({
    super.key,
    required this.size,
  ...
  @override
  State<ForgotPasswordContentTablet> createState() => _ForgotPasswordContentTabletState();
}

class _ForgotPasswordContentTabletState extends State<ForgotPasswordContentTablet> {
  @override
