...
class ForgotPasswordFormContentDesktop extends StatefulWidget {
  const ForgotPasswordFormContentDesktop({
    super.key,
    required this.size,
  ...
  @override
  State<ForgotPasswordFormContentDesktop> createState() => _ForgotPasswordFormContentDesktopState();
}

class _ForgotPasswordFormContentDesktopState extends State<ForgotPasswordFormContentDesktop> {
