...
class ChangeProfileContentDesktop extends StatefulWidget {
  const ChangeProfileContentDesktop({
    super.key,
    required this.size,
  ...
  @override
  State<ChangeProfileContentDesktop> createState() => _ChangeProfileContentDesktopState();
}

class _ChangeProfileContentDesktopState extends State<ChangeProfileContentDesktop> {
  ...
  void initState() {
    setState(() {
      ...
      // namaLengkapController.text = "Irwanto Kogawa Datebayo Uzumaki Hutagaol Uzumaki Hutagaol Uzumaki Hutagaol";
