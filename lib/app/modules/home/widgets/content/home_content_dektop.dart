...
class HomeContentDektop extends StatelessWidget {
  const HomeContentDektop({
    super.key,
    required this.size,
    required this.state,
    this.controller,
            ...
            headerSliverBuilder: (
              ...
              return <Widget>[
                SliverAppBar(
                  ...
                  expandedHeight: state.data.searchIsStart ? 80.0 : 320.0,
                  collapsedHeight: state.data.searchIsStart ? 80.0 : 320.0,
                  flexibleSpace: Column(
                    children: [
                      ...
                      Visibility(
                        ...
                        child: HomeHeaderDesktopComponent(
                          state: state,
                          size: size,
